...
public class TraderDataTxt {
	...
	// if val3 = 2 add new user - dealWithTraderTxt(user details, "", 1)
	public synchronized int dealWithTraderTxt(String val1, String val2, int val3) {
		...
		if(val3 == 1) {
			...
			flag = fho.addNewToFile(val1, fpath); // add new user // if success return 3 else 2
		}
		
		return flag;
	}
	
	// check user name and password // if yes return 1 else 0
